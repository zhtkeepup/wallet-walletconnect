...
export default function useInitialization() {
    ...
    const onInitialize = useCallback(async () => {
        try {
            ...
            //     await createOrRestoreMultiversxWallet();
            ...
            console.log("zht-setEIP155Address:", eip155Addresses);
    ...
    console.log("zht-useInitialization,relayerRegionURL:", relayerRegionURL);
    console.log("zht-useInitialization,initialized:", initialized);
    return initialized;
}
