...
export function createOrRestoreEIP155Wallet() {
    ...
    console.log("zht-createOrRestoreEIP155Wallet,mnemonic1:", mnemonic1);
    console.log("zht-createOrRestoreEIP155Wallet,mnemonic2:", mnemonic2);
    ...
    console.log("zht-createOrRestoreEIP155Wallet1:", eip155Wallets);
    console.log("zht-createOrRestoreEIP155Wallet2:", eip155Addresses);
    return {
        eip155Wallets,
        eip155Addresses,
    };
