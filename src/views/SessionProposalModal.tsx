...
export default function SessionProposalModal() {
    ...
    console.log("zzz999,SessionProposalModal,0,data:", data);
...
*/
        return {
            eip155: {
                ...
                accounts: eip155Chains
                    .map((chain) =>
                        eip155Addresses.map((account) => `${chain}:${account}`)
                    )
                    .flat(),
            },
            /*
            cosmos: {
                ...
                accounts: cosmosChains
                    .map((chain) =>
                        cosmosAddresses.map((address) => `${chain}:${address}`)
                    )
                    .flat(),
            },
            kadena: {
                ...
                accounts: kadenaChains
                    .map((chain) =>
                        kadenaAddresses.map((address) => `${chain}:${address}`)
                    )
                    .flat(),
            },
            mvx: {
            ...
            near: {
                ...
                accounts: nearChains
                    .map((chain) =>
                        nearAddresses.map((address) => `${chain}:${address}`)
                    )
                    .flat(),
            },
            polkadot: {
            ...
            solana: {
                ...
                accounts: solanaChains
                    .map((chain) =>
                        solanaAddresses.map((address) => `${chain}:${address}`)
                    )
                    .flat(),
            },
            tezos: {
                ...
                accounts: tezosChains
                    .map((chain) =>
                        tezosAddresses.map((address) => `${chain}:${address}`)
                    )
                    .flat(),
            },
            tron: {
                ...
                accounts: tronChains
                    .map((chain) =>
                        tronAddresses.map((address) => `${chain}:${address}`)
                    )
                    .flat(),
            },
            */
        ...
        if (proposal && namespaces) {
            ...
            try {
                if (reorderedEip155Accounts.length > 0) {
                    ...
                    namespaces.eip155.accounts = reorderedEip155Accounts.concat(
    ...
    return (
        <RequestModal
            ...
            infoBoxCondition={
                notSupportedChains.length > 0 || supportedChains.length === 0
            }
            disableApprove={
                notSupportedChains.length > 0 || supportedChains.length === 0
            }
